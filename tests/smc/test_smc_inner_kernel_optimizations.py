...
from blackjax.smc.optimizations.inner_kernel_parameter_update import (
...
class ParameterTuningStrategiesTest(chex.TestCase):
    ...
    def test_smc_inner_kernel_tuning_on_creation(self):
        ...
        (new_state, new_parameter_override), info = kernel.step(
...
class InverseMassMatrixFromParticles(chex.TestCase):
    ...
    def test_inverse_mass_matrix_from_multivariable_particles(self):
        """
        # this would be two vars, two particles, in R1.
        """
        # particles = [jnp.array([10.0, 15.0]), jnp.array([3.0, 4.0])]
